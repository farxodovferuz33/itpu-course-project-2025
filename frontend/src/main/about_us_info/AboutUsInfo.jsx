            ...
            <div className={"aboutUsInfo"} >
                ...
                <div>
                    ...
                    <div className={"infoAll"} >
                        ...
                        {lang==="RU"?"«Company Name» предлагает туристические пакеты.В пакете «Company name» вы станете свидетелем незабываемых моментов благодаря прекрасным развлекательным путешествиям по Узбекистану.\n" +
                            ...
                            "                        Мы ждем вас!!!":"\"Company Name\" sayyohlik paketlarini taqdim etadi.Siz \"Company Name\" paketida Òzbekiston bòylab ajoyib ko'ngilochar sayohatlar orqali   unutilmas lahzalarning guvohi bo'lasiz.\n" +
